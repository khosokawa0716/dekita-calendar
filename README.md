...
| 2   | タスクテンプレート作成 /task-templates | 繰り返し設定付きテンプレートの登録・複数子ども割り当て      | ✅ 利用可              | ❌ 不可               | ✅ 完了     |
| 3   | タスク一覧画面 /tasks                  | 今日のタスク一覧表示・子どもごとの完了状況確認             | ✅ 利用可              | ❌ 不可               | ✅ 完了     |
| 6   | タスク作成画面 /tasks/add              | タスクの作成・複数子どもへの同時割り当て                   | ✅ 利用可              | ❌ 不可               | ✅ 完了     |
| 4   | カレンダー画面 /tasks/calendar         | 月ごとのタスク達成度表示・今日のタスク管理                 | ✅ 利用可              | ✅ 利用可             | ✅ 完了     |
| 5   | カレンダー内タスク管理                 | 自分に割り当てられたタスクの完了チェック・コメント記録     | ✅ 表示＋監視可        | ✅ 編集可             | ✅ 完了     |
